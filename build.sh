...
rm -rf ROOTFS usr.manifest x86_64-native-osvapp-gcc examples/*/build/*
make install T=x86_64-native-osvapp-gcc OSV_SDK=`readlink -f ../..` || exit $?
...
mkdir -p ROOTFS
find x86_64-native-osvapp-gcc/app/ -executable -readable -type f -exec cp -v {} ROOTFS/ \;
